...
const projectLists = [
  {
    ...
    policyUrl: '/pages/index/msgDetail?id=386',
    condition:
      `
  ...
  },
  {
    ...
    policyUrl: '/pages/index/msgDetail?id=384',
    condition:
      `
  ...
  },
  {
    ...
    policyUrl: '/pages/index/msgDetail?id=387',
    condition:
      `
  ...
  },
  {
    ...
    policyUrl: '/pages/index/msgDetail?id=388',
    condition:
      `
      1.已获评<span class="light">国家高新技术企业</span>;
      2.省级及以上的研发机构;
  ...
  },
  {
    ...
    policyUrl: '/pages/index/msgDetail?id=389',
    condition:
      `
      1.符合申报指南;
  ...
  },
  {
    ...
    policyUrl: '/pages/index/msgDetail?id=383',
    condition:
      `
  ...
  },
  {
    ...
    policyUrl: '/pages/index/msgDetail?id=381',
    condition:
      `
  ...
  },
  {
    ...
    policyUrl: '/pages/index/msgDetail?id=382',
    condition:
      `
      1.杭州市范围登记、纳税，注册成立时间≥1年且≤5年，且注册资金不高于1000万元;
      2.具备知识产权;
